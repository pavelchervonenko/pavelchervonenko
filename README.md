...
![LightGBM](https://img.shields.io/badge/LightGBM-02BAAD?style=flat-square)
...
|---|---|---|
| [Task Manager](https://github.com/pavelchervonenko/java-project-99) | Full-featured task management web app with auth, roles, labels | Spring Boot 3, JWT, JPA, PostgreSQL, Docker |
| [Page Analyzer](https://github.com/pavelchervonenko/java-project-72) | Web service for SEO analysis of pages: status, title, h1, meta | Javalin, PostgreSQL, HikariCP |
| [Data Validator](https://github.com/pavelchervonenko/java-project-78) | Fluent validation library for strings, numbers and maps | Java, JUnit 5 |
| [Diff Calculator](https://github.com/pavelchervonenko/java-project-71) | CLI tool to diff JSON/YAML files with multiple output formats | Java, CLI, Jackson, SnakeYAML |
| [Cryptography](https://github.com/pavelchervonenko/cryptography-5sem) | DES, AES (Rijndael), RSA, GF(2⁸) — all implemented from scratch | Java 17, multithreading |
